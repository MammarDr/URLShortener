...
namespace UrlShortener.Core.Services.Interfaces
{
    public interface IUrlService
    {
        ...
        Task<Result<(IEnumerable<URL> Urls, int Count)>>          RetrieveAllOwnedUrlsAsync(Result<UrlParameters> UrlParam, int userId, CancellationToken ct = default); // ==> Call Data-Layer
